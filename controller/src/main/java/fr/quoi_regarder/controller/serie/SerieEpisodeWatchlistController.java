...
import fr.quoi_regarder.service.serie.SerieEpisodeWatchlistService;
...
public class SerieEpisodeWatchlistController {
    ...
    public ResponseEntity<ApiResponse<Void>> addEpisode(
        ...
        serieEpisodeWatchlistService.addToWatchlist(userId, serieId, dto);
    ...
    public ResponseEntity<ApiResponse<Void>> updateStatus(
        ...
        serieEpisodeWatchlistService.updateStatus(userId, serieId, episodeId, updateStatusRequest.getStatus());
